    ...
    public static String receiveCppMessage(String json) {
        if (json != null) {
            try {
                ...
                StoreUtils.LogDebug("NdkGlue", "retParamsJson: " + retParamsJson.toString());
                return retParamsJson.toString();
            } catch (JSONException e) {
                Log.e(TAG, "receiveCppMessage raised exception", e);
                StoreUtils.LogError("NdkGlue", "receiveCppMessage raised exception" + e);
            } catch (UnsupportedOperationException e) {
                Log.e(TAG, "", e);
                StoreUtils.LogError("NdkGlue", "Unsupported operation (" + e + ")");
            } catch (Exception e) {
                Log.e(TAG, "", e);
                StoreUtils.LogError("NdkGlue", "Unknown exception (" + e + ")");
            }
